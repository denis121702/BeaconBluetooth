		...
		org.altbeacon.beacon.MonitorNotifier
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AltBeaconLibrary.Sample.Droid.MonitorNotifier, AltBeaconLibrary.Sample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MonitorNotifier.class, __md_methods);
	}
	...
	public MonitorNotifier () throws java.lang.Throwable
	{
		...
		if (getClass () == MonitorNotifier.class)
			mono.android.TypeManager.Activate ("AltBeaconLibrary.Sample.Droid.MonitorNotifier, AltBeaconLibrary.Sample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
